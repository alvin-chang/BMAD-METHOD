...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for QA standards for this project - {root}/core-config.yaml qaLoadAlwaysFiles list
